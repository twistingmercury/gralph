.PHONY: build help install uninstall
...
local-build: ## Performs only a local build of gralph
	@go build -o ${LOCAL_BUILD}/gralph ./cmd/main/main.go

full-build: ## Performs a full build of gralph
	./build/build.sh
